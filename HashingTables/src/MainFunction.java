    ...
    public static void main(String[] args) {
        ...
        if (args.length == 4) { //either of dleft or multi
            ...
            if (hashType.equalsIgnoreCase("cuckoo")) {
                ...
                tab.print();
            } else if (hashType.equalsIgnoreCase("all")) {  //implement all hashing algorithms
                MultiTable mlt = new MultiTable(noOfEntries, noOfHashes);
                mlt.insert(flowArray);
                mlt.print();

                DLeftTable dlft = new DLeftTable(noOfEntries, noOfHashes);
                ...
                System.err.println("Error parsing arguments. Expected either of 'cuckoo' or 'all' as 1st argument.");
                System.exit(1);
            }
        } else {
